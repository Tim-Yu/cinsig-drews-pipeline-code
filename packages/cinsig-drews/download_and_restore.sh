...
for ref in \
    "third_party/drews_compendium/Section 5 Robustness analysis/Section 5.2 Signature stability across genomic technologies/input/Data_preparation/refgenome/hg19.chrom.sizes.txt" \
    "third_party/drews_compendium/Section 5 Robustness analysis/Section 5.2 Signature stability across genomic technologies/input/Data_preparation/refgenome/gap_hg19.txt" \
    "third_party/drews_compendium/Section 5 Robustness analysis/Section 5.2 Signature stability across genomic technologies/input/Data_preparation/refgenome/hg38.chrom.sizes.txt" \
    "third_party/drews_compendium/Section 5 Robustness analysis/Section 5.2 Signature stability across genomic technologies/input/Data_preparation/refgenome/gap_hg38.txt"
do
...
chmod +x "$DEST_DIR/scripts/run_full_workflow.sh" "$DEST_DIR/scripts/run_drews_pipeline.sh" || true
